// $Id: cheque_master.h,v 1.20 2004/01/31 01:50:31 arandell Exp $
//
...
#ifndef CHEQUE_MASTER_H
#define CHEQUE_MASTER_H
...
class ChequeMaster: public DataWindow {
    Q_OBJECT
public:
    ChequeMaster(MainWindow* main, Id cheque_id=INVALID_ID);
    ~ChequeMaster();
