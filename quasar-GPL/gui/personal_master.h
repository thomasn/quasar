// $Id: personal_master.h,v 1.17 2005/02/03 08:19:28 bpepers Exp $
//
...
#ifndef PERSONAL_MASTER_H
#define PERSONAL_MASTER_H
...
class PersonalMaster: public DataWindow {
    Q_OBJECT
public:
    PersonalMaster(MainWindow* main, Id personal_id=INVALID_ID);
    ~PersonalMaster();
