// $Id: vendor_master.h,v 1.18 2005/02/03 08:19:28 bpepers Exp $
//
...
#ifndef VENDOR_MASTER_H
#define VENDOR_MASTER_H
...
class VendorMaster: public DataWindow {
    Q_OBJECT
public:
    VendorMaster(MainWindow* main, Id vendor_id=INVALID_ID);
    ~VendorMaster();
