// $Id: location_list.h,v 1.9 2004/01/31 01:50:31 arandell Exp $
//
...
class LocationList: public ActiveList {
    Q_OBJECT
public:
    LocationList(MainWindow* main);
    ~LocationList();
...
protected:
    ...
    virtual bool isActive(Id location_id);
    virtual void setActive(Id location_id, bool active);
