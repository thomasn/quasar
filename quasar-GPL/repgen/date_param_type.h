// $Id: date_param_type.h,v 1.4 2004/10/12 05:46:26 bpepers Exp $
//
...
#ifndef DATE_PARAM_TYPE_H
#define DATE_PARAM_TYPE_H

#include "report_param_type.h"

class DateParamType: public ReportParamType {
public:
    DateParamType();
    ~DateParamType();
