// $Id: code_data_source.h,v 1.5 2004/08/09 23:44:53 bpepers Exp $
//
...
#ifndef CODE_DATA_SOURCE_H
#define CODE_DATA_SROUCE_H

#include "data_source.h"

class CodeDataSource: public DataSource {
public:
    CodeDataSource();
    ~CodeDataSource();

    // Type name
    QString type() const { return "code"; }
    ...
    // Interpreter code for initialize, next, and get
    QString initCode;
    QString nextCode;
    QString getCode;
