// $Id: double_param_type.h,v 1.4 2004/10/12 05:46:26 bpepers Exp $
//
...
#ifndef DOUBLE_PARAM_TYPE_H
#define DOUBLE_PARAM_TYPE_H

#include "report_param_type.h"

class DoubleParamType: public ReportParamType {
public:
    DoubleParamType();
    ~DoubleParamType();

    // Type name
    QString type() const { return "double"; }
