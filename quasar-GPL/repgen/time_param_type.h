// $Id: time_param_type.h,v 1.4 2004/10/12 05:46:26 bpepers Exp $
//
...
#ifndef TIME_PARAM_TYPE_H
#define TIME_PARAM_TYPE_H

#include "report_param_type.h"

class TimeParamType: public ReportParamType {
public:
    TimeParamType();
    ~TimeParamType();
