// $Id: bool_param_type.h,v 1.4 2004/10/12 05:46:26 bpepers Exp $
//
...
#ifndef BOOL_PARAM_TYPE_H
#define BOOL_PARAM_TYPE_H

#include "report_param_type.h"

class BoolParamType: public ReportParamType {
public:
    BoolParamType();
    ~BoolParamType();

    // Type name
    QString type() const { return "bool"; }
