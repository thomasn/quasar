// $Id: string_param_type.h,v 1.4 2004/10/12 05:46:26 bpepers Exp $
//
...
#ifndef STRING_PARAM_TYPE_H
#define STRING_PARAM_TYPE_H

#include "report_param_type.h"

class StringParamType: public ReportParamType {
public:
    StringParamType();
    ~StringParamType();
