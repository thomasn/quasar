// $Id: number_text_format.cpp,v 1.2 2005/02/15 08:07:36 bpepers Exp $
//
...
{
    NumberTextFormat* format = new NumberTextFormat();
    *format = *this;
    return format;
}

QString
NumberTextFormat::format(const QString& value)
{
